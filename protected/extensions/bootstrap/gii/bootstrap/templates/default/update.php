...
?>
	...
	array('label'=>Yii::t('<?php echo $this->modelClass; ?>','View <?php echo $this->modelClass; ?>'),'url'=>array('view','id'=>$model-><?php echo $this->tableSchema->primaryKey; ?>)),
	array('label'=>Yii::t('<?php echo $this->modelClass; ?>','Manage <?php echo $this->modelClass; ?>'),'url'=>array('admin')),
	);
	?>
	
	<h1><?php echo "<?php"; ?> Yii::t('<?php echo $this->modelClass; ?>', "Update <?php echo $this->modelClass; ?> #{ID}", array('{ID}'=><?php echo "\$model->{$this->tableSchema->primaryKey}"; ?>)); ?> </h1>
